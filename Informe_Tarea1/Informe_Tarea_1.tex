...
En este documento se encontrará lo que es el proceso de diseño de un inversor de tamaño mínimo en la tecnología ON-semiconductor 0.5 en el cual se dimensionará el PMOS de acuerdo a un análisis estático(misma corriente en los transistores con tensión de inversion igual a la mitad de la alimentación) y a un análisis dinámico (menor tiempo de retardo en los tiempos de levantamiento y caída).
