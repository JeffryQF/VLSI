...
En este documento se presentan los resultados del diseño del esquemático y trazado de una compuerta OAI-22 + INV. Este diseño incluye la dimensión de los transistores a partir de la teoría de esfuerzo lógico y se comparará con la aproximación de Elmore para comprobar su veracidad en los cálculos.
...
Para lo cual se hizo el esquemático mostrado en la figura \ref{fig:OAI21_Cargas} y se hizo el diagrama de palitos mostrado en la figura \ref{fig:palitos). En este diagrama se tiene dibujado tanto la compuerta OAI22 como el inversor para cambiar el nivel lógico a la salida.

\begin{figure}[htbp]
  \centering
    \includegraphics[scale=0.2]{./Palitos.png}
    \rule{35em}{0.5pt}
...
\begin{figure}[htbp]
  \centering
    \includegraphics[scale=0.5]{./Circuito electric.png}
    \rule{35em}{0.5pt}
...
\begin{figure}[htbp]
\begin{center}
    \includegraphics[scale=0.5]{./mejor caso red nmos.png}
    \rule{35em}{0.5pt}
